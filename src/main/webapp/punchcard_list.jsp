...
<script type="text/html" id="toolbarDemo">
    <div class="demoTable">
        ...
        <div class="layui-inline layui-show-xs-block">
            ...
            <button class="layui-btn layui-btn-sm" lay-event="add"><i class="layui-icon"></i>打卡</button>
        </div>
    </div>
</script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'punId', title: 'ID', sort: true, fixed: 'left', totalRowText: '合计'}
                , {field: 'punEmp', title: '打卡人编码'}
                , {field: 'punTime', title: '打卡时间'}
        ...
        var $ = layui.$, active = {
            reload: function () {
                ...
                table.reload('testReload', {
                    url: '/punchCard/searchPunchCard',
                    page: {
                        curr: 1 //重新从第 1 页开始
                    }
                    , where: {
                        punEmp: demoReload.val(),  //data.field.userName  //obj.data
                        punTimeBegin: demoReloadBegin.val(),
                        punTimeEnd: demoReloadEnd.val()
                    }
                }, 'data');
            }
        };
        ...
        table.on('toolbar(test)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'isAll':
                    ...
                    break;
                case 'add':
                    xadmin.open("添加记录", "punchcard_insert.jsp", 550, 450);
                    break;
            }
        });
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                $.ajax({
                    type: 'get',
                    url: '/punchCard/delete',
                    dataType: 'json',
                    data: {
                        punId: data.punId  //obj.data
                    },
                    success: function (data) {
                        if (data.code == 200) {
                            obj.del();
                ...
                xadmin.open("查看界面", '/punchCard/loadById?punId=' + data.punId, 550, 350)
            }
        });
    });
</script>
