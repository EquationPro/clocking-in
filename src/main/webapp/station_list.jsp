    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                ,{field: 'staId', title: 'ID', sort: true, fixed: 'left', totalRowText: '合计'}
                , {field: 'staCode', title: '岗位编码' }
                , {field: 'staName', title: '岗位名称'}
                , {field: 'staDepartment', title: '所在部门'}
                , {field: 'staHead', title: '直接上级'}
                , {field: 'staCategory', title: '岗位类别'}
        ...
        var $ = layui.$, active = {
            reload: function () {
                ...
                table.reload('testReload', {
                    url: '/station/searchStation',
                    page: {
                        curr: 1 //重新从第 1 页开始
                    }
                    , where: {
                        staNameOrStaCode: demoReload.val()   //data.field.userName  //obj.data
                    }
                }, 'data');
            }
        };
        ...
        table.on('toolbar(test)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'isAll':
                    ...
                    break;
                case 'add':
                   xadmin.open("添加记录","station_insert.jsp",600 ,650);
                    break;
            }
        });
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                // layer.close(index);
                    ...
                    xadmin.open("修改信息",'/station/loadById?staId=' + data.staId,700,400)
            }
        });
    });
</script>
