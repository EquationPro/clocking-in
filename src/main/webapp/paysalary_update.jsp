...
<body>
<form class="layui-form" action="/paySalary/update" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select id="payEmp" name="payEmp" required lay-verify="required">
                <option value="${paySalary.payEmp}">${paySalary.payEmp}</option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select id="payEmpName" name="payEmpName" required lay-verify="required">
                <option value="${paySalary.payEmpName}">${paySalary.payEmpName}</option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="payBegin" name="payBegin" placeholder="开始时间" required lay-verify="required" value="${paySalary.payBegin}" autocomplete="off" class="layui-input">
        </div>
        <div class="layui-form-mid layui-word-aux"></div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="payEnd" name="payEnd" placeholder="结束时间" required lay-verify="required" value="${paySalary.payEnd}" autocomplete="off" class="layui-input">
        </div>
        <div class="layui-form-mid layui-word-aux"></div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="paySal" name="paySal" required lay-verify="required"  autocomplete="off" value="${paySalary.paySal}" class="layui-input">
        </div>
        <div class="layui-form-mid layui-word-aux"></div>
    </div>
    <div class="layui-form-item">
